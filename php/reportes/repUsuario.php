<?php
	...
	$res=R::getAll('select id,nombre_usuario,apellido_usuario,cargo_usuario,direccion_usuario,celular_usuario FROM usuarios');
 ?>
...
<page backtop="10mm" backbottom"10mm" backleft="20mm" backright="20mm" footer="page" backimg="../../img/logo.jpg" backimgw="15%" backimgx="left" backimgy="top">
	...
	<table class="tabla">
			<tr class="titulo">
				...
				<td class="col22">APELLIDO</td>
				<td class="col3">CARGO</td>
				<td class="col4">DIRECCION</td>
				<td class="col5">CELULAR</td>
			</tr>
		<?php 
