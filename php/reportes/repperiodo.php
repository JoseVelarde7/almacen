...
<page backtop="10mm" backbottom"10mm" backleft="20mm" backright="20mm" footer="page">
	...
	<div class="caja1">
		<h3 align="center">VENTAS DESDE <?php echo $inicio. " HASTA ".$fn; ?></h3>
	</div>
	<br><br>
	<table class="tabla">
			<tr class="titulo">
	...
	<div align="center">
		<h3>Productos Vendidos <?php echo $ca; ?></h3>
		<h3>Monto Total Ingresos <?php echo $total; ?> Bs.</h3>
	</div>
