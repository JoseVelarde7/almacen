<?php
	...
	$res=R::getAll('select tabservicios.id,nombre_servicio,fecha_servicio,nombre_cliente,costo_servicio from tabservicios join clientes on clientes.cod_cliente=tabservicios.cod_cliente');
 ?>
...
<page backtop="10mm" backbottom"10mm" backleft="20mm" backright="20mm" footer="page" backimg="../../img/logo.jpg" backimgw="15%" backimgx="left" backimgy="top">
	...
	<div class="caja1">
		<h3 align="center">LISTA VENTA DE SERVICIOS</h3>
	</div>
	<br><br>
	<table class="tabla">
			<tr class="titulo">
				...
				<td class="col3">FECHA</td>
				<td class="col4">CLIENTE</td>
				<td class="col5">COSTO</td>
			</tr>
		<?php 
