...
<?php
	...
	$codigo=$_GET['io'];
	$res=R::getAll('select cod_proveedor,razon_proveedor,representante_proveedor,nit_proveedor,direccion_proveedor,correo_proveedor,celular_proveedor,telefono_proveedor,notas_proveedor FROM proveedores WHERE id='.$codigo);
	$datos=[];
...
<page backtop="10mm" backbottom"10mm" backleft="20mm" backright="20mm" footer="page">
	...
	<div class="caja1">
		<h3 align="center">PROVEEDOR: <?php echo $datos[1];?></h3>
	</div>
	<br><br>
	<table class="tabla">
		<tr class="titulo">
		...
		<tr>
				<td class="col1">REPRESENTANTE</td>
