<?php
	...
	$codigo=$_GET['io'];
	$res=R::getAll('select nombre_cliente,cod_cliente,fecha_cliente,direccion_cliente,celular_cliente,telefono_cliente,correo_cliente,nit_cliente,nombre_nit FROM clientes WHERE id='.$codigo);
	$datos=[];
...
<page backtop="10mm" backbottom"10mm" backleft="20mm" backright="20mm" footer="page">
	...
	<div class="caja1">
		<h3 align="center">CLIENTE: <?php echo $datos[0];?></h3>
	</div>
	<br><br>
	<table class="tabla">
		<tr class="titulo">
		...
		<tr>
			...
			<tr>
				<td class="col1">NOMBRE DEL NIT</td>
