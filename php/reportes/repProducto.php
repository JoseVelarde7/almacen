...
<?php
	...
	$res=R::getAll('select productos.id,producto_productos,descripcion_producto,precio_productos,almacen.precio,almacen.cantidad FROM productos join almacen on productos.cod_producto=almacen.cod_producto');
 ?>
...
<page backtop="10mm" backbottom"10mm" backleft="20mm" backright="20mm" footer="page" backimg="../../img/logo.jpg" backimgw="15%" backimgx="left" backimgy="top">
	...
	<table class="tabla">
			<tr class="titulo">
				...
				<td class="col5">PRECIO VENTA</td>
				<td class="col6">PRECIO COMPRA</td>
				<td class="col7">CANTIDAD ACTUAL</td>
			</tr>
		<?php 
