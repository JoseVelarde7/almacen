...
<body>
	...
	<section class="full-width pageContent">
		<div class="mdl-tabs mdl-js-tabs mdl-js-ripple-effect">
			<div class="mdl-tabs__tab-bar">
				<a href="#tabNewAdmin" class="mdl-tabs__tab is-active">LISTA DE SERVICIOS</a>
				<a href="#tabListAdmin" class="mdl-tabs__tab">REGISTRAR NUEVO SERVICIO</a>
			</div>
								...
								<form action="#">
									<div class="mdl-textfield mdl-js-textfield mdl-textfield--expandable">
										...
										<div style="float:right;">
											<a href="../php/reportes/transServicio.php" class="mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect mdl-button--colored bg-info" target="blank"><i style="margin-top:13px;" class="zmdi zmdi-print"></i></a>
										</div>
									</div>
								</form>
								<div class="mdl-list">
								...
								<form name="registrarService" id="registrarService">
									<div class="mdl-grid">
										<div class="mdl-cell mdl-cell--4-col-phone mdl-cell--8-col-tablet mdl-cell--12-col-desktop">
											...
											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
												<textarea class="mdl-textfield__input" name="descripcion" id="descripcion" maxlength="150" cols="30" rows="2"></textarea>
									...
									<p class="text-center">
										...
										<div id="nuevo1">
											<a href="service.php" class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--colored bg-primary" id="nuevo"><span style="color:#fff">Nuevo Registro</span>
											</a>	
										</div>
										<div class="mdl-tooltip" for="registrar">Agregar Servicio</div>
										<div align="center">
											<h3 id="mensaje"></h3>
										</div>
									</p>
	...
	<div class="remodal" data-remodal-id="modal" role="dialog" aria-labelledby="modal1Title" aria-describedby="modal1Desc">
		  ...
		  <div>
		    <h2 id="modal1Title">Nuevo Tipo de Servicio</h2>
				<div class="mdl-cell mdl-cell--4-col-phone mdl-cell--8-col-tablet mdl-cell--12-col-desktop">
					<form name="registrarService2" id="registrarService2">
									<div class="mdl-grid">
										<div class="mdl-cell mdl-cell--4-col-phone mdl-cell--8-col-tablet mdl-cell--12-col-desktop">
											<h5 class="text-condensedLight">Nombre del Tipo</h5>
											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
												<input class="mdl-textfield__input" type="text" name="nombre3" id="nombre3">
												<label class="mdl-textfield__label" for="carnet">Nombre del Tipo de Servicio</label>
												<span class="mdl-textfield__error">Nombre Invalido</span>
											</div>
											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
												<input class="mdl-textfield__input" type="text" name="codigo3" id="codigo3">
												<label class="mdl-textfield__label" for="codigo">Abreviacion del Tipo Servicio</label>
												<span class="mdl-textfield__error">Error Invalido</span>
											</div>
											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
												<textarea class="mdl-textfield__input" name="descripcion3" id="descripcion3" maxlength="150" cols="30" rows="2"></textarea>
												<label class="mdl-textfield__label" for="descripcion">Descripcion del Tipo Servicio</label>
												<span class="mdl-textfield__error">Descripcion Invalida</span>
											</div>
										</div>
									</div>
									<p class="text-center">
										<button class="mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect mdl-button--colored bg-primary" id="registrar3">
											<i class="zmdi zmdi-plus"></i>
										</button>
										<div align="center">
											<h3 id="mensaje3"></h3>
