<?php 
  ...
  $res=R::getAll('select id,cod_tipo,nombre_tipo,description_tipo FROM tiposervicio WHERE id='.$ide.'');
?>
<!DOCTYPE html>
<html lang="es">
<head>
	...
	<script>
		$(document).on('ready',function(){
			...
			$('#editar').click(function(e){
				e.preventDefault();
				$("#nombre,#codigo,#descripcion").removeAttr("readonly");
				$('#editar').hide();
				$('#eliminar').hide();
				$('#modificar').show();
			});
			$('#modificar').on('click',function(e){
	          ...
	          type:'post',
	          data: "valor=modificarServicio"+"&"+dat,
	          beforeSend:function(){
    		...
    		function(isConfirm) {
                ...
                $.ajax({
	                  url:'../php/registros.php',
	                  type:'post',
	                  data: "valor=anularServicio&ide="+ide+"",
	                  beforeSend:function(){
	                      $('.faocu').css('display','inline')
	                  },
	                  success: function(resp){
					...
					<div class="full-width panel-content">
						<form name="registrarService" id="registrarService">
							...
							<div class="mdl-grid">
								<div class="mdl-cell mdl-cell--4-col-phone mdl-cell--8-col-tablet mdl-cell--12-col-desktop">
									...
									<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
										<input class="mdl-textfield__input" type="text" name="nombre" id="nombre" value="<?php echo $res[0]['nombre_tipo']; ?>" readonly>
										<label class="mdl-textfield__label" for="carnet">Nombre del Servicio</label>
										<span class="mdl-textfield__error">Nombre Invalido</span>
									</div>
									<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
										<input class="mdl-textfield__input" type="text" name="codigo" id="codigo" value="<?php echo $res[0]['cod_tipo']; ?>" readonly>
										<label class="mdl-textfield__label" for="codigo">Abreviacion del Servicio</label>
										<span class="mdl-textfield__error">Error Invalido</span>
									</div>
									<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
										<textarea class="mdl-textfield__input" name="descripcion" id="descripcion" maxlength="150" cols="30" rows="2" readonly><?php echo $res[0]['description_tipo']; ?></textarea>
							...
							<p class="text-center">
								...
								<a href="services.php" class="mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect mdl-button--colored bg-warning" id="volver">
