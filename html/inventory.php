	...
	<section class="full-width pageContent">
		...
		<div class="mdl-tabs mdl-js-tabs mdl-js-ripple-effect">
			<div class="mdl-tabs__tab-bar">
				<a href="#tabNewProduct1" class="mdl-tabs__tab is-active">INVENTARIO</a>
				<a href="#tabNewProduct" class="mdl-tabs__tab">KARDEX</a>
				<a href="#tabNewProduct2" class="mdl-tabs__tab">KARDEX EXISTENCIA</a>
			</div>
				...
				<div class="mdl-grid">
					<div class="mdl-cell mdl-cell--4-col-phone mdl-cell--8-col-tablet mdl-cell--8-col-desktop mdl-cell--2-offset-desktop">
						<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
							<input class="mdl-textfield__input" type="text" name="producto" id="producto" style="width: 273%;">
						...
						<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label" align="center">
							<a href="#" class="mdl-js-button" id="generar">Agregar</a>
						</div>
						<table class="mdl-data-table mdl-js-data-table mdl-shadow--2dp full-width table-responsive">
							<thead>
								<tr>
			...
			<div class="mdl-tabs__panel" id="tabNewProduct2">
				<div class="mdl-grid">
					<div class="mdl-cell mdl-cell--4-col-phone mdl-cell--8-col-tablet mdl-cell--12-col-desktop">
						<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label" style="width: 300px;">
							<input class="mdl-textfield__input" type="text" name="producto2" id="producto2" style="width: 200%;">
							<label class="mdl-textfield__label" for="cliente">Productos</label>
							<input type="text" name="codpro2" id="codpro2" style="display:none;">
						</div>
						<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label" align="center">
							<a href="#" class="mdl-js-button" id="generar2">Agregar</a>
						</div>
						<table class="mdl-data-table mdl-js-data-table mdl-shadow--2dp full-width table-responsive">
							<thead>
								<tr>
									...
									<th>SAL TOTAL</th>
									<th>EXIS CANTIDAD</th>
									<th>EXIS VALOR UNITARIO</th>
									<th>EXIS VALOR TOTAL</th>
								</tr>
							</thead>
							<tbody class="cont2">
							</tbody>
