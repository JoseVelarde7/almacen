	...
	<head>
		...
		<title>Factura</title>
	  	...
	  	<script src="//ajax.googleapis.com/ajax/libs/jquery/1.11.2/jquery.min.js"></script>
			...
			<script src="../js/factura2.js"></script>
	...
	<body>
      ...
      <span><img alt="" style="width: 150px;" src="../img/logo.jpg"></span>
		...
		<article style="margin-top:-40px;">
			<h1>Recipient</h1>
			<address contenteditable>
				<p><div id="fnombre"><?php echo $nombre;?></div><br><div id="fnit">Ingrese Nit</div></p>
			</address>
      <div align="right">ORIGINAL CLIENTE</div>
			<table class="meta">
				<tr>
					<th><span>Factura #</span></th>
					<td><div id="numberInvoice"></div></td>
				</tr>
				<tr>
					<th><span>Fecha</span></th>
					<td><span id="fechaInvoice"><?php echo date("Y-m-d");?></span></td>
				</tr>
				<tr>
					<th><span>NIT</span></th>
          <td><span>5005515001</span></td>
			...
			<table class="inventory">
				<thead>
					<tr>
						<th><span contenteditable>Servicio</th>
						<th><span contenteditable>Cantidad</span></th>
						<th><span contenteditable>Costo Servicio</span></th>
			...
			<table class="balance">
				<tr>
					...
					<td><span data-prefix>Bs</span><span id="totalInvoice"></span></td>
				</tr>
			</table>
			<br><br><br>
			<div id="letter">
      ...
      <div align="right" id="demo"></div>
        ...
        <p>LEY Nro 453: El proveedor deberá entregar el producto en las modalidades y términos ofertados o convenidos</p></div>
